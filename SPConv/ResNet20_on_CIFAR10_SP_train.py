...
import SPConv.ResNet20_on_CIFAR10_SP as ResNet20_on_CIFAR10_SP

model_names = sorted(name for name in ResNet20_on_CIFAR10_SP.__dict__
                     if name.islower() and not name.startswith("__")
                     and name.startswith("resnet")
                     and callable(ResNet20_on_CIFAR10_SP.__dict__[name]))
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet20',
                    ...
                    ' (default: resnet20)')
parser.add_argument('--Alpha', default=0.25, type=float, metavar='A',
                    help='Alpha')
...
parser.add_argument('--resume', default='./checkpointResNet20_CIFAR10_0.25/model_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: ./checkpointResNet20_CIFAR10_0.25/model_best.pth.tar)')
...
def main():
    ...
    model = ResNet20_on_CIFAR10_SP.__dict__[args.arch]()
    print_log("=> network :\n {}".format(model), log)
