...
class BasicModule(nn.Module):
    def __init__(self, input, output, DW_size=3, stride=1, Alpha=0.46):
        ...
        self.DW = nn.Sequential(
            nn.Conv2d(self.DW_input, self.DW_output, kernel_size=1, stride=self.stride, padding=0, groups=self.group, bias=False),
            nn.BatchNorm2d(self.DW_output))
