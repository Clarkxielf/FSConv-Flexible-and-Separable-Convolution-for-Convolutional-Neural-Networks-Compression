...
import FSConv.VGG16_on_CIFAR10_FSConv as VGG16_on_CIFAR10_FSConv
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='vgg16_bn',
                    ...
                    ' (default: vgg16_bn)')
parser.add_argument('--Alpha', default=0.46, type=float, metavar='A',
                    help='Alpha')
...
parser.add_argument('--resume', default='./checkpointVGG16_0.46/model_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: ./checkpointVGG16_0.46/model_best.pth.tar)')
