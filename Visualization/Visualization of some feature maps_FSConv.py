...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet20',
                    ...
                    ' (default: resnet20)')
parser.add_argument('--resume', default='../FSConv/checkpointResNet20_CIFAR10_0.9_2/model_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: ../FSConv/checkpointResNet20_CIFAR10_0.9_2/model_best.pth.tar)')
