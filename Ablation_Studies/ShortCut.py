...
class BasicModule(nn.Module):
    def __init__(self, input, output, DW_size=3, stride=1, Alpha=0.74):
    ...
    def forward(self, x):
        ...
        out = self.se(F.relu(out2, inplace=True))
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A', Beta=2.4):
