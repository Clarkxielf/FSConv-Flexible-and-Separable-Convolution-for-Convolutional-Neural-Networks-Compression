...
import Ablation_Studies.SE as ResNet20_on_CIFAR10_FSConv
...
parser.add_argument('--resume', default='./checkpointResNet20_CIFAR10_0.9_2_SE/model_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: ./checkpointResNet20_CIFAR10_0.9_2_SE/model_best.pth.tar)')
