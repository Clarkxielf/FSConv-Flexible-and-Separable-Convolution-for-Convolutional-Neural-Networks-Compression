...
import Baseline.ResNet20_on_CIFAR10 as ResNet20_on_CIFAR10
...
parser.add_argument('--resume', default='./checkpointResNet20_CIFAR10/model_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: ./checkpointResNet20_CIFAR10/model_best.pth.tar)')
