...
from Baseline.ResNet50_on_IMAGENET import *
...
parser.add_argument('--save-dir', dest='save_dir',
                    ...
                    default='./checkpointResNet', type=str)
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true', default=True,
                    help='evaluate model on validation set')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoitn, (default: ./checkpointResNet50/model_best.pth.tar)')
